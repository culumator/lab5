...
void print_char(Xuint32 BaseAddress, unsigned char ch){
	VGA_PERIPH_MEM_mWriteMemory(BaseAddress + TEXT_MEM_OFF + cursor_position -24, (ch-0x40));

}

void set_foreground_color(Xuint32 BaseAddress, unsigned int data){
	VGA_PERIPH_MEM_mWriteMemory(BaseAddress + 0x00000010, data);
}

void set_background_color(Xuint32 BaseAddress, unsigned int data){
	VGA_PERIPH_MEM_mWriteMemory(BaseAddress + 0x00000014, data);
}

void set_font_size(Xuint32 BaseAddress, unsigned int data){
